...
mod tests 
{
   ...
   #[test]
   #[should_panic(exprected = "Title cannot be longer than 50 bytes." )]
   fn title_cannot_be_more_than_fifty_chars()
   {
   ...
   fn description_cannot_be_larger_than_500_chars()
   {
